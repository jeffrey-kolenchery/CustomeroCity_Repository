            ...
            <div className="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
                ...
                <div className="h-full ml-14 mt-14 mb-10 md:ml-64">
                    <div className="flex justify-end px-6 p-2 gap-3">
                        <button onClick={OnSubmit} type="submit" className="bg-purple-600 text-white px-8 py-1 rounded-lg">{editable ? 'Edit Fields' : ''}</button>
                        <Link to='#'
                            onClick={(e) => {
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 p-4 gap-4">
                        ...
                        <section className="mt-4 w-full border rounded-xl bg-gray-50 mb-2 ml-2">
                            <textarea readOnly={editable} className="w-full bg-gray-50 p-2 rounded-xl" placeholder="Unique Identifiers" id="UniqueIdentifiers" rows="4" ></textarea>
                        </section>
                        <section className="mt-4 w-full border rounded-xl bg-gray-50 mb-2 ml-2">
