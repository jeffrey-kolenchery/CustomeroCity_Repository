...
const UserProfile = () => {
    ...
    return (
        <>
            ...
            <MainButton size={15} style={{position: 'absolute', top: 15 , left: 1020}}>Update/Edit</MainButton>
            <MainButton size={15} style={{position: 'absolute', top: 15 , left: 1220}}>Delete</MainButton>
