          ...
          <>
              <div className="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
                  ...
                  <div className="h-full ml-14 mt-44 mb-10 md:ml-96">
                      <div className="flex font-mono h-full bg-white items-center justify-center">
                          <div className="grid bg-white border-2 border-purple-200 shadow-xl w-11/12 md:w-9/12 lg:w-1/2">
                              <div className="flex justify-center">
                                  <div className="flex">
                                      <h1 className="text-gray-600 font-bold md:text-xl text-xl mt-6">Reset Password</h1>
                                  </div>
                              </div>
                              <form onSubmit = {handleSubmit((data) => {
                                  ...
                                  <div className="grid grid-cols-1 mt-4 mx-7">
                                      <label className="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Current Password</label>
                                      <input className="py-1 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="text" placeholder="Current Password" {...register("currentPassword", { required: true })} />
                                  </div>
                                  <div className="grid grid-cols-1 mt-4 mx-7">
